---
name: site
description: Static web hosting for sites, single-page applications, reports, and dashboards. Use when the user wants to publish or redeploy a static directory, roll back a release, patch a published file, attach a custom domain, or password-protect a site.
...
<help command="clor site auth">
<summary>Manage HTTP basic auth on a site</summary>
<usage>clor site auth</usage>
...
<help command="clor site auth remove">
<summary>Remove HTTP basic auth from a site</summary>
<usage>clor site auth remove <SUBDOMAIN></usage>
...
<output-example format="json">
{
  ...
  "owner_team_id": "0197f39e-7b18-7a55-8d11-44c9a1e8f200",
  "spa_fallback": false,
  "status": "active",
...
<examples-good>
- clor site auth remove my-cool-blog    # drops basic auth
</examples-good>
</help>


<help command="clor site auth set">
<summary>Require HTTP basic auth on a site</summary>
<usage>clor site auth set <SUBDOMAIN> [flags]</usage>
...
<examples-good>
- clor site auth set my-cool-blog --username editor --password s3cret    # visitors must authenticate
</examples-good>
</help>

<help command="clor site config">
<summary>Update site configuration</summary>
<usage>clor site config <SUBDOMAIN> [flags]</usage>
...
<examples-good>
- clor site config my-cool-blog --domain blog.example.com    # also serve the site at a DNS-verified custom domain
- clor site config my-cool-blog --spa    # serve index.html on unmatched routes
- clor site config my-cool-blog --max-hits-per-minute 600    # tighten the request rate limit
</examples-good>
</help>

<help command="clor site create">
<summary>Claim a subdomain and create a site</summary>
<usage>clor site create <SUBDOMAIN> [flags]</usage>

<uses>
- claiming a subdomain before the first deploy
- creating an account-wide site with --owner team
</uses>
...
<flags>
- --owner string: set to "team" to create an account-wide site; defaults to your user
</flags>
...
<examples-good>
- clor site create my-cool-blog    # creates a user-owned site at my-cool-blog.clor.app
- clor site create launch --owner team    # account-wide site (requires admin)
</examples-good>

<examples-bad>
- clor site create www    # reserved subdomains are rejected
- clor site create My_Site    # subdomains are lowercase letters, digits, and hyphens only
</examples-bad>
</help>

<help command="clor site delete">
<summary>Delete a site and its files</summary>
<usage>clor site delete <SUBDOMAIN></usage>
...
<examples-good>
- clor site delete my-cool-blog    # soft deletes; the sweeper reaps the files
</examples-good>
</help>

<help command="clor site deploy">
<summary>Deploy a directory as the live release</summary>
<usage>clor site deploy <SUBDOMAIN> <DIR></usage>
...
<examples-good>
- clor site deploy my-cool-blog ./dist    # uploads ./dist as the live release
</examples-good>

<examples-bad>
- clor site deploy my-cool-blog ./dist/index.html    # pass the directory, not a single file
</examples-bad>
</help>

<help command="clor site file">
...
<help command="clor site file delete">
<summary>Delete one file from a site's live release</summary>
<usage>clor site file delete <SUBDOMAIN> <REMOTE_PATH></usage>
...
<examples-good>
- clor site file delete my-cool-blog old-post.html    # drops the file and its compressed variants
- clor site file delete my-cool-blog posts/2026-06-07.html    # delete a nested path
- clor site file delete my-cool-blog stale.css --stdout-format json | jq '.file_count'    # JSON, confirm the new file count
</examples-good>

<examples-bad>
- clor site file delete my-cool-blog    # the remote path argument is required
- clor site file delete my-cool-blog ../other-site/index.html    # the path must stay inside the release
</examples-bad>
</help>


<help command="clor site file download">
<summary>Download one file from a site's live release</summary>
<usage>clor site file download <SUBDOMAIN> <REMOTE_PATH> [LOCAL_PATH]</usage>
...
<examples-good>
- clor site file download my-cool-blog index.html ./index.html    # save the live index.html locally
- clor site file download my-cool-blog feed.xml    # stream the file to stdout
- clor site file download my-cool-blog posts/2026-06-07.html ./entry.html    # fetch a nested path to a local name
</examples-good>

<examples-bad>
- clor site file download my-cool-blog    # the remote path argument is required
- clor site file download my-cool-blog /etc/passwd    # the path must stay inside the release; absolute paths are rejected
</examples-bad>
</help>


<help command="clor site file list">
<summary>List the files served by a site's live release</summary>
<usage>clor site file list <SUBDOMAIN></usage>
...
<examples-good>
- clor site file list my-cool-blog    # one event=file line per served file
- clor site file list my-cool-blog --stdout-format json | jq '.files[].path'    # JSON, pull served paths
- clor site file list my-cool-blog | grep '^event=file '    # logfmt, filter to file lines
</examples-good>

<examples-bad>
- clor site file list    # the subdomain argument is required
- clor site file list https://my-cool-blog.clor.app    # pass the bare subdomain, not a URL
</examples-bad>
</help>


<help command="clor site file upload">
<summary>Upload or replace one file in a site's live release</summary>
<usage>clor site file upload <SUBDOMAIN> <LOCAL_PATH> [REMOTE_PATH]</usage>
...
<examples-good>
- clor site file upload my-cool-blog ./index.html    # served at / as index.html
- clor site file upload my-cool-blog ./entry.html posts/2026-06-07.html    # write to a nested remote path
- clor site file upload my-cool-blog ./feed.xml --stdout-format json | jq '.total_bytes'    # JSON, read the new site size
</examples-good>

<examples-bad>
- clor site file upload my-cool-blog ./dist    # upload takes one file; use deploy for a directory
- clor site file upload my-cool-blog    # the local path argument is required
</examples-bad>
</help>

<help command="clor site list">
<summary>List the sites the caller can see</summary>
<usage>clor site list</usage>
...
<examples-good>
- clor site list    # one event=site line per site
- clor site list --stdout-format json | jq '.sites[].subdomain'    # JSON, pull subdomains
</examples-good>
</help>

<help command="clor site releases">
<summary>List the retained releases for a site, oldest first</summary>
<usage>clor site releases <SUBDOMAIN></usage>
...
<examples-good>
- clor site releases my-cool-blog    # one event=release line per retained release
</examples-good>
</help>

<help command="clor site rollback">
<summary>Roll the live release back to a chosen or the previous release</summary>
<usage>clor site rollback <SUBDOMAIN> [flags]</usage>
...
<examples-good>
- clor site rollback my-cool-blog    # rolls back to the immediately previous release
- clor site rollback my-cool-blog --release 01900000-0000-7000-8000-000000000001    # rolls back to a specific release
</examples-good>
</help>

<help command="clor site show">
<summary>Show one site including size, current release, and file count</summary>
<usage>clor site show <SUBDOMAIN></usage>
...
<examples-good>
- clor site show my-cool-blog    # one event=site line
</examples-good>
</help>
